...
namespace Mercury.BLL
{
    public static class CommonUtility
    {
        ...
        public static string GetChineseCh(string source)
        {
            ...
            return pure.Length > 80 ? pure.Substring(0, 80) + "..." : pure.Substring(0, pure.Length);
        }
        ...
        public static string RemoveStyle(string content)
        {
            ...
            content = content.Replace("&nbsp;", "").Replace("border=1", "");
            return content;
        }
        ...
        {
            var model = new Mercury.BLL.Provinces().GetModel(int.Parse(provinceId));
            if (model != null)
