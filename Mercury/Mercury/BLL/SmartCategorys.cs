...
namespace Mercury.BLL
{
	...
	{
		private readonly Mercury.DAL.SmartCategorys dal=new Mercury.DAL.SmartCategorys();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Mercury.Model.SmartCategorys GetModelByCache(int SmartCategoryId)
		{
			...
			return (Mercury.Model.SmartCategorys)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Mercury.Model.SmartCategorys> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Mercury.Model.SmartCategorys> DataTableToList(DataTable dt)
		{
			List<Mercury.Model.SmartCategorys> modelList = new List<Mercury.Model.SmartCategorys>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Mercury.Model.SmartCategorys model;
