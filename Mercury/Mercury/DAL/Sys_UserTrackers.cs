...
namespace Mercury.DAL
{
	...
	public partial class Sys_UserTrackers
	{
		...
		public int Add(Mercury.Model.Sys_UserTrackers model)
		{
			...
			strSql.Append("TrackerName,TrackerCityIds,TrackerIndustryIds,CreateTime,Keyword1,Keyword2,Keyword3,Keyword4,Keyword5,Sys_UserId)");
		...
		public bool Update(Mercury.Model.Sys_UserTrackers model)
		{
			...
			parameters[8].Value = model.Keyword5;
			parameters[9].Value = model.Sys_UserId;
			parameters[10].Value = model.UserTrackerId;
		...
		public Mercury.Model.Sys_UserTrackers GetModel(int UserTrackerId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 UserTrackerId,TrackerName,TrackerCityIds,TrackerIndustryIds,CreateTime,Keyword1,Keyword2,Keyword3,Keyword4,Keyword5,Sys_UserId from Sys_UserTrackers ");
			strSql.Append(" where UserTrackerId=@UserTrackerId");
			SqlParameter[] parameters = {
					new SqlParameter("@UserTrackerId", SqlDbType.Int,4)
			};
			...
			Mercury.Model.Sys_UserTrackers model=new Mercury.Model.Sys_UserTrackers();
		...
		/// 得到一个对象实体
		/// </summary>
		public Mercury.Model.Sys_UserTrackers DataRowToModel(DataRow row)
		{
			Mercury.Model.Sys_UserTrackers model=new Mercury.Model.Sys_UserTrackers();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select UserTrackerId,TrackerName,TrackerCityIds,TrackerIndustryIds,CreateTime,Keyword1,Keyword2,Keyword3,Keyword4,Keyword5,Sys_UserId ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" UserTrackerId,TrackerName,TrackerCityIds,TrackerIndustryIds,CreateTime,Keyword1,Keyword2,Keyword3,Keyword4,Keyword5,Sys_UserId ");
			strSql.Append(" FROM Sys_UserTrackers ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
