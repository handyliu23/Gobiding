...
namespace GoBiding.DAL
{
	...
	public partial class Message
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(GoBiding.Model.Message model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Message(");
			strSql.Append("Title,Content,MessageTime,IsRead,SenderId,ReceiverId,MessageType,PId)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(GoBiding.Model.Message model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public GoBiding.Model.Message GetModel(int Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,Title,Content,MessageTime,IsRead,SenderId,ReceiverId,MessageType,PId from Message ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
			...
			GoBiding.Model.Message model=new GoBiding.Model.Message();
		...
		/// 得到一个对象实体
		/// </summary>
		public GoBiding.Model.Message DataRowToModel(DataRow row)
		{
			GoBiding.Model.Message model=new GoBiding.Model.Message();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,Title,Content,MessageTime,IsRead,SenderId,ReceiverId,MessageType,PId ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,Title,Content,MessageTime,IsRead,SenderId,ReceiverId,MessageType,PId ");
			strSql.Append(" FROM Message ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
