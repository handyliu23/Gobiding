...
namespace GoBiding.BLL
{
	...
	{
		private readonly GoBiding.DAL.Sys_UserTrackers dal=new GoBiding.DAL.Sys_UserTrackers();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public GoBiding.Model.Sys_UserTrackers GetModelByCache(int UserTrackerId)
		{
			...
			return (GoBiding.Model.Sys_UserTrackers)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<GoBiding.Model.Sys_UserTrackers> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<GoBiding.Model.Sys_UserTrackers> DataTableToList(DataTable dt)
		{
			List<GoBiding.Model.Sys_UserTrackers> modelList = new List<GoBiding.Model.Sys_UserTrackers>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				GoBiding.Model.Sys_UserTrackers model;
