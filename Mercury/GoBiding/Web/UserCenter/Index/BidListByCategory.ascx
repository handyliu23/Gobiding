<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BidListByCategory.ascx.cs"
    Inherits="GoBiding.Web.UserCenter.Index.BidListByCategory" %>
<style>
            .bidlabel
        {
            margin-left: 10px;
...
<div class="col-lg-12">
    ...
    <div style="width: 100%;">
        ...
        <div class="col-lg-10" id="tablecontent">
            ...
            <table id="bidlisttypediv2" style="display: none;">
                <asp:Repeater runat="server" ID="rptBidList2">
                    <ItemTemplate>
                        <tr>
                            <td style="width: 90%; line-height: 35px; vertical-align: top;">
                                <a href='/BidDetail.aspx?bId=<%#Eval("BidId")%>' style="font-size: 14px; text-decoration: none;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               color: #444; font-weight: 500;">
                                    <%#Eval("BidTitle").ToString().Length > 50 ? Eval("BidTitle").ToString().Substring(0, 50) + "..." : Eval("BidTitle").ToString()%></a><br />
                                <span class="bidlabel">类型 |
                                    <%#GetBidTypeValue(Eval("BidType").ToString())%></span> <span class="bidlabel">地区 |
            ...
            <table id="bidlisttypediv3" style="display: none;">
                <asp:Repeater runat="server" ID="rptBidList3">
                    <ItemTemplate>
                        <tr>
                            <td style="width: 90%; line-height: 35px; vertical-align: top;">
                                <a href='/BidDetail.aspx?bId=<%#Eval("BidId")%>' style="font-size: 14px; text-decoration: none;
            ...
            <table id="bidlisttypediv4" style="display: none;">
                <asp:Repeater runat="server" ID="rptBidList4">
                    <ItemTemplate>
                        <tr>
                            <td style="width: 90%; line-height: 35px; vertical-align: top;">
                                <a href='/BidDetail.aspx?bId=<%#Eval("BidId")%>' style="font-size: 14px; text-decoration: none;
            ...
            <table id="bidlisttypediv5" style="display: none;">
                <asp:Repeater runat="server" ID="rptBidList5">
                    <ItemTemplate>
                        <tr>
                            <td style="width: 90%; line-height: 35px; vertical-align: top;">
                                <a href='/BidDetail.aspx?bId=<%#Eval("BidId")%>' style="font-size: 14px; text-decoration: none;
                                    ...
                                    <%#GetBidTypeValue(Eval("BidType").ToString())%></span> <span class="bidlabel">地区 |
                                        <%#GetProvinceName(Eval("ProvinceId").ToString())%></span> <span class="bidlabel">编号
                                            <%#Eval("BidNumber")%></span> <span class="bidlabel" style='display: <%# Eval("BidCompanyName") == "" ? "none":""%>'>
                                                <a href='/CompanyBidList.aspx?CompanyName=<%#Eval("BidCompanyName") %>' style='color: green;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               text-decoration: none;'>招标人 |
                                                    <%# Eval("BidCompanyName").ToString().Length > 10 ? Eval("BidCompanyName").ToString().Substring(0, 10) +"...": Eval("BidCompanyName").ToString()%></a>
                                            </span>
                            </td>
                            <td style="width: 120px; height: 60px; font-size: 12px; line-height: 60px;">
                                <%#Eval("BidPublishTime", "{0:D}")%>
