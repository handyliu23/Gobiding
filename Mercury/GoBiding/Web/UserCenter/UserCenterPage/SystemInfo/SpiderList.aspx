<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UserCenter/UserCenterHeader.master"
    CodeBehind="SpiderList.aspx.cs" ValidateRequest="false" Inherits="GoBiding.Web.UserCenter.UserCenterPage.SystemInfo.SpiderList" %>
    ...
    <aside class="right-side">                
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#">系统信息</a></li>
                <li class="active">MercurySpiders</li>
            </ol>
        </section>
    ...
    <div id="mainContent" runat="server">
        <table>
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID="txtSpiderUrl" Width="300" Height="26"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th>
            ...
            <tr>
                ...
                <td colspan="6">
                    <asp:TextBox TextMode="MultiLine" runat="server" ID="txtCookies" Width="1100" Height="58"></asp:TextBox>
            ...
            <tr>
                <td>快速查询</td>
                <td colspan="3">SpiderName<asp:TextBox id="txtspidernameforsearch" runat="server" width="200"></asp:TextBox>
                SpiderUrl<asp:TextBox id="txtspiderurlforsearch" runat="server" width="200"></asp:TextBox>
                <asp:Button runat="server" id="btnQuickSearch" Text="查询" Width="100" 
                        onclick="btnQuickSearch_Click" />
                </td>
                <td colspan="2">
                    SpiderId:<asp:literal runat="server" id="ltrSpiderId"></asp:literal>
                </td>
        ...
        <br />
        <div style="width:100%;">
            <div style="float:left;">历史总共抓取数量：<asp:Literal runat="server" ID="ltrTotalCount"></asp:Literal></div>
            <div style="float:left; width:100%;">
              <webdiyer:AspNetPager ID="AspNetPager2" runat="server" UrlPaging="true" NumericButtonCount="30" CloneFrom="AspNetPager1"
                CssClass="pagination" LayoutType="Ul" PagingButtonLayoutType="UnorderedList"
                PagingButtonSpacing="0" CurrentPageButtonClass="active" PageSize="60">
            </webdiyer:AspNetPager></div>
         </div>
                                                                                                                                                                                                                                                                                                                    <div style="font-size: 12px; word-break: break-all; width:100%;">
        <asp:GridView runat="server" AllowPaging="False" PageSize="50" AutoGenerateColumns="False"
            ...
            <Columns>
                <asp:BoundField DataField="SpiderId" HeaderText="ID" ItemStyle-Width="60"></asp:BoundField>
...
<%--                <asp:TemplateField HeaderText="抓取总数">
        ...
        <webdiyer:AspNetPager ID="AspNetPager1" runat="server" Width="100%" UrlPaging="true" NumericButtonCount="30"
            CssClass="pagination" LayoutType="Ul" PagingButtonLayoutType="UnorderedList"
