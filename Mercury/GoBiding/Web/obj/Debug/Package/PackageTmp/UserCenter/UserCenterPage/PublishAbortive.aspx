<%@ Page Title="" Language="C#" MasterPageFile="~/UserCenter/UserCenterHeader.master"
    AutoEventWireup="true" CodeBehind="PublishAbortive.aspx.cs" Inherits="GoBiding.Web.UserCenter.UserCenterPage.PublishAbortive" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <aside class="right-side">                
        ...
        <section class="content-header">
            <h1>
                发布中止流标信息
                <small>采购或工程招投标中投标人不足三家，或所有投标都被否决后用户可以发布中止招标、流标信息!</small>
            </h1>
            <ol class="breadcrumb">
