<%@ Page Title="Bids" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="GoBiding.Web.Bids.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="BidFileNameURI" HeaderText="BidFileNameURI" SortExpression="BidFileNameURI" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="BidSpiderName" HeaderText="BidSpiderName" SortExpression="BidSpiderName" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="BidCategoryId" HeaderText="BidCategoryId" SortExpression="BidCategoryId" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="BidCompanyId" HeaderText="BidCompanyId" SortExpression="BidCompanyId" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="BidCompanyName" HeaderText="BidCompanyName" SortExpression="BidCompanyName" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="BidOpenTime" HeaderText="BidOpenTime" SortExpression="BidOpenTime" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="BidPlatFrom" HeaderText="BidPlatFrom" SortExpression="BidPlatFrom" ItemStyle-HorizontalAlign="Center"  /> 
