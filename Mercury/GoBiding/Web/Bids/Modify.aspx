<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="GoBiding.Web.Bids.Modify" Title="修改页" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtBidFileNameURI" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		BidSpiderName
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtBidSpiderName" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		BidCategoryId
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtBidCategoryId" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		BidCompanyId
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtBidCompanyId" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		BidCompanyName
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtBidCompanyName" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		BidOpenTime
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox ID="txtBidOpenTime" runat="server" Width="70px"  onfocus="setday(this)"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		BidPlatFrom
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtBidPlatFrom" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
</table>
